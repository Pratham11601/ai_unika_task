...
class CustomTextField extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return TextFormField(
      ...
      enabled: enabled,
      readOnly: readOnly,
      style: TextHelper.size18.merge(style),
      cursorWidth: 1,
      maxLength: maxLength,
      maxLines: maxLines,
      ...
      decoration: decoration ??
          InputDecoration(
            ...
            labelStyle: TextHelper.size20.merge(labelStyle).copyWith(
              color: Colors.grey
            ),
            hintText: isMandatory ? '$hintText *' : hintText,
            hintStyle: TextHelper.size16.copyWith(color: Colors.grey.withValues(alpha: 0.75)).merge(hintStyle),
